...
@Component({
  selector: 'app-tvs-login',
  templateUrl: './tvs-login.component.html',
  styleUrls: ['./tvs-login.component.scss']
})
export class TvsLoginComponent implements OnInit {

  password: any;

  show = false;
  constructor(private fb: FormBuilder, public route: Router, private AuthenticationService: AuthenticationService) { }
  ...
  onSubmit() {
    ...
    this.route.navigate(['/customerMod']);
